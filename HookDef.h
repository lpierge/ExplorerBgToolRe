...
*/
#define CreateMHook(fun,mfun,ofun,index) {if(MH_CreateHook(&fun,&mfun,(LPVOID*)&ofun)!=MH_OK) MessageBoxW(NULL,(L"Failed to create hook "+std::to_wstring(index)).c_str(),L"ExplorerBgToolRe",MB_ICONERROR|MB_SYSTEMMODAL|MB_OK);}
//LPI
